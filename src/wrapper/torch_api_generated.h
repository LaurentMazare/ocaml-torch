...
void atg_max_unpool2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, tensor indices, int64_t *output_size_data, int output_size_len);
...
void atg_max_unpool3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, tensor indices, int64_t *output_size_data, int output_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len);
...
void atg_nanquantile(tensor *, tensor self, tensor q, int64_t dim, int keepdim);
void atg_nanquantile_new(tensor *, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation);
void atg_nanquantile_new_out(tensor *, tensor out, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation);
void atg_nanquantile_new_scalar(tensor *, tensor self, double q, int64_t dim, int keepdim, char * interpolation);
void atg_nanquantile_new_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim, int keepdim, char * interpolation);
void atg_nanquantile_out(tensor *, tensor out, tensor self, tensor q, int64_t dim, int keepdim);
void atg_nanquantile_scalar(tensor *, tensor self, double q, int64_t dim, int keepdim);
void atg_nanquantile_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim, int keepdim);
...
void atg_quantile(tensor *, tensor self, tensor q, int64_t dim, int keepdim);
void atg_quantile_new(tensor *, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation);
void atg_quantile_new_out(tensor *, tensor out, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation);
void atg_quantile_new_scalar(tensor *, tensor self, double q, int64_t dim, int keepdim, char * interpolation);
void atg_quantile_new_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim, int keepdim, char * interpolation);
void atg_quantile_out(tensor *, tensor out, tensor self, tensor q, int64_t dim, int keepdim);
void atg_quantile_scalar(tensor *, tensor self, double q, int64_t dim, int keepdim);
void atg_quantile_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim, int keepdim);
...
void atg_searchsorted_scalar(tensor *, tensor sorted_sequence, scalar self, int out_int32, int right);
...
void atg_solve_solution(tensor *, tensor solution, tensor lu, tensor self, tensor A);
