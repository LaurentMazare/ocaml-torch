...
void atg_to_sparse(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_bsc(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_bsc_out(tensor *, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_bsr(tensor *, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_bsr_out(tensor *, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_csc(tensor *, tensor self, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_csc_out(tensor *, tensor out, tensor self, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_csr(tensor *, tensor self, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_csr_out(tensor *, tensor out, tensor self, int64_t dense_dim_v, int dense_dim_null);
void atg_to_sparse_out(tensor *, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null);
