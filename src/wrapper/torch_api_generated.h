...
void atg_sparse_coo_tensor(tensor *, long int *size_data, int size_len, int options_kind, int options_device);
void atg_sparse_coo_tensor1(tensor *, tensor indices, tensor values, int options_kind, int options_device);
void atg_sparse_coo_tensor2(tensor *, tensor indices, tensor values, long int *size_data, int size_len, int options_kind, int options_device);
