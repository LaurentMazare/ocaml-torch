...
void atg_avg_pool2d_out(tensor *, tensor out, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad);
...
void atg_avg_pool3d_out(tensor *, tensor out, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad);
...
void atg_cumprod_out(tensor *, tensor out, tensor self, int64_t dim);
void atg_cumprod_out1(tensor *, tensor out, tensor self, int64_t dim, int dtype);
void atg_cumsum(tensor *, tensor self, int64_t dim);
void atg_cumsum1(tensor *, tensor self, int64_t dim, int dtype);
void atg_cumsum_out(tensor *, tensor out, tensor self, int64_t dim);
void atg_cumsum_out1(tensor *, tensor out, tensor self, int64_t dim, int dtype);
...
void atg_mean2(tensor *, tensor self, int64_t *dim_data, int dim_len, int keepdim);
void atg_mean3(tensor *, tensor self, int64_t *dim_data, int dim_len, int dtype);
void atg_mean4(tensor *, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype);
void atg_mean_out(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim);
void atg_mean_out1(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int dtype);
void atg_mean_out2(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype);
...
void atg_mkldnn_reshape(tensor *, tensor self, int64_t *shape_data, int shape_len);
...
void atg_prod_out(tensor *, tensor out, tensor self, int64_t dim, int keepdim);
void atg_prod_out1(tensor *, tensor out, tensor self, int64_t dim, int dtype);
void atg_prod_out2(tensor *, tensor out, tensor self, int64_t dim, int keepdim, int dtype);
void atg_pstrf(tensor *, tensor self, int upper);
void atg_pstrf_out(tensor *, tensor u, tensor pivot, tensor self, int upper);
...
void atg_quantize_linear(tensor *, tensor self, double scale, int64_t zero_point);
...
void atg_quantized_lstm(tensor *, tensor input, tensor *hx_data, int hx_len, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional, int batch_first);
...
void atg_s_copy_(tensor *, tensor self, tensor src, int non_blocking);
...
void atg_sum_out(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim);
void atg_sum_out1(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int dtype);
void atg_sum_out2(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int keepdim, int dtype);
