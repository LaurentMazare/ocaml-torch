...
void atg_linalg_matrix_norm_str_ord(tensor *, tensor self, char * ord, int64_t *dim_data, int dim_len, int keepdim, int dtype);
void atg_linalg_matrix_norm_str_ord_out(tensor *, tensor out, tensor self, char * ord, int64_t *dim_data, int dim_len, int keepdim, int dtype);
...
void atg_repeat_interleave_self_int(tensor *, tensor self, int64_t repeats, int64_t dim);
void atg_repeat_interleave_self_tensor(tensor *, tensor self, tensor repeats, int64_t dim);
