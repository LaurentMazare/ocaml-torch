...
void atg__amp_update_scale(tensor *, tensor out, tensor self, tensor growth_tracker, tensor found_inf, double scale_growth_factor, double scale_backoff_factor, int64_t growth_interval);
...
void atg__amp_update_scale_functional(tensor *, tensor self, tensor growth_tracker, tensor found_inf, double scale_growth_factor, double scale_backoff_factor, int64_t growth_interval);
...
void atg__coalesced(tensor *, tensor out, tensor self, int coalesced);
void atg__coalesced_(tensor *, tensor self, int coalesced);
void atg__coalesced_functional(tensor *, tensor self, int coalesced);
...
void atg__histogramdd_from_bin_cts(tensor *, tensor self, int64_t *bins_data, int bins_len, tensor weight, int density);
void atg__histogramdd_from_bin_tensors(tensor *, tensor self, tensor *bins_data, int bins_len, tensor weight, int density);
void atg__index_put_impl(tensor *, tensor out, tensor self, tensor *indices_data, int indices_len, tensor values, int accumulate, int unsafe);
void atg__index_put_impl_(tensor *, tensor self, tensor *indices_data, int indices_len, tensor values, int accumulate, int unsafe);
void atg__index_put_impl_functional(tensor *, tensor self, tensor *indices_data, int indices_len, tensor values, int accumulate, int unsafe);
...
void atg__linalg_check_errors(tensor *, tensor info, char * api_name, int is_matrix);
void atg__linalg_inv_out_helper(tensor *, tensor out, tensor self, tensor infos_lu, tensor infos_getri);
void atg__linalg_inv_out_helper_(tensor *, tensor self, tensor infos_lu, tensor infos_getri);
void atg__linalg_inv_out_helper_functional(tensor *, tensor self, tensor infos_lu, tensor infos_getri);
void atg__linalg_qr_helper(tensor *, tensor self, char * mode);
...
void atg__masked_softmax(tensor *, tensor self, tensor mask, int64_t dim);
void atg__masked_softmax_backward(tensor *, tensor grad_output, tensor output, tensor mask, int64_t dim);
...
void atg__mps_linear(tensor *, tensor self, tensor weight, tensor bias);
void atg__mps_linear_backward_input(tensor *, int64_t *input_size_data, int input_size_len, tensor grad_output, tensor weight);
void atg__mps_linear_backward_weights(tensor *, tensor grad_output, tensor input, tensor weight, int bias_defined);
...
void atg__native_multi_head_attention(tensor *, tensor query, tensor key, tensor value, int64_t embed_dim, int64_t num_head, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, tensor mask, int need_weights, int average_attn_weights);
...
void atg__nested_tensor_from_mask(tensor *, tensor t, tensor mask);
void atg__nested_tensor_layer_norm(tensor *, tensor self, tensor weight, tensor bias, double eps);
...
void atg__pad_enum(tensor *, tensor self, int64_t *pad_data, int pad_len, int64_t mode, double value);
...
void atg__resize_output(tensor *, tensor out, tensor self, int64_t *size_data, int size_len, int device);
void atg__resize_output_(tensor *, tensor self, int64_t *size_data, int size_len, int device);
void atg__resize_output_functional(tensor *, tensor self, int64_t *size_data, int size_len, int device);
...
void atg__segment_reduce_backward(tensor *, tensor grad, tensor output, tensor data, char * reduce, tensor lengths, int64_t axis);
...
void atg__transformer_encoder_layer_fwd(tensor *, tensor src, int64_t embed_dim, int64_t num_heads, tensor qkv_weight, tensor qkv_bias, tensor proj_weight, tensor proj_bias, int use_gelu, int norm_first, double eps, tensor norm_weight_1, tensor norm_bias_1, tensor norm_weight_2, tensor norm_bias_2, tensor ffn_weight_1, tensor ffn_bias_1, tensor ffn_weight_2, tensor ffn_bias_2, tensor mask);
...
void atg__upsample_bicubic2d_aa(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h, double scales_w);
void atg__upsample_bicubic2d_aa_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h, double scales_w);
void atg__upsample_bicubic2d_aa_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h, double scales_w);
void atg__upsample_bicubic2d_aa_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h, double scales_w);
void atg__upsample_bilinear2d_aa(tensor *, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h, double scales_w);
void atg__upsample_bilinear2d_aa_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h, double scales_w);
void atg__upsample_bilinear2d_aa_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h, double scales_w);
void atg__upsample_bilinear2d_aa_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, int align_corners, double scales_h, double scales_w);
void atg__upsample_nearest_exact1d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales);
void atg__upsample_nearest_exact1d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales);
void atg__upsample_nearest_exact1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales);
void atg__upsample_nearest_exact1d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales);
void atg__upsample_nearest_exact2d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_h, double scales_w);
void atg__upsample_nearest_exact2d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h, double scales_w);
void atg__upsample_nearest_exact2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h, double scales_w);
void atg__upsample_nearest_exact2d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_h, double scales_w);
void atg__upsample_nearest_exact3d(tensor *, tensor self, int64_t *output_size_data, int output_size_len, double scales_d, double scales_h, double scales_w);
void atg__upsample_nearest_exact3d_backward(tensor *, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d, double scales_h, double scales_w);
void atg__upsample_nearest_exact3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d, double scales_h, double scales_w);
void atg__upsample_nearest_exact3d_out(tensor *, tensor out, tensor self, int64_t *output_size_data, int output_size_len, double scales_d, double scales_h, double scales_w);
void atg__validate_sparse_bsc_tensor_args(tensor *, tensor ccol_indices, tensor row_indices, tensor values, int64_t *size_data, int size_len);
void atg__validate_sparse_bsr_tensor_args(tensor *, tensor crow_indices, tensor col_indices, tensor values, int64_t *size_data, int size_len);
void atg__validate_sparse_csc_tensor_args(tensor *, tensor ccol_indices, tensor row_indices, tensor values, int64_t *size_data, int size_len);
...
void atg_aminmax(tensor *, tensor self, int64_t dim, int keepdim);
void atg_aminmax_out(tensor *, tensor min, tensor max, tensor self, int64_t dim, int keepdim);
...
void atg_arange_start_out(tensor *, tensor out, scalar start, scalar end);
...
void atg_argmax_out(tensor *, tensor out, tensor self, int64_t dim, int keepdim);
void atg_argmin(tensor *, tensor self, int64_t dim, int keepdim);
void atg_argmin_out(tensor *, tensor out, tensor self, int64_t dim, int keepdim);
...
void atg_as_strided_copy(tensor *, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset);
void atg_as_strided_copy_out(tensor *, tensor out, tensor self, int64_t *size_data, int size_len, int64_t *stride_data, int stride_len, int64_t storage_offset);
...
void atg_avg_pool2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override);
...
void atg_avg_pool3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int ceil_mode, int count_include_pad, int64_t divisor_override);
...
void atg_bernoulli_float_out(tensor *, tensor out, tensor self, double p);
void atg_bernoulli_out(tensor *, tensor out, tensor self);
void atg_bernoulli_p(tensor *, tensor self, double p);
void atg_bernoulli_tensor_functional(tensor *, tensor self, tensor p);
void atg_bernoulli_tensor_out(tensor *, tensor out, tensor self, tensor p);
...
void atg_cauchy(tensor *, tensor out, tensor self, double median, double sigma);
void atg_cauchy_(tensor *, tensor self, double median, double sigma);
void atg_cauchy_functional(tensor *, tensor self, double median, double sigma);
...
void atg_col2im_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *kernel_size_data, int kernel_size_len, int64_t *dilation_data, int dilation_len, int64_t *padding_data, int padding_len, int64_t *stride_data, int stride_len);
...
void atg_copy_sparse_to_sparse(tensor *, tensor out, tensor self, tensor src, int non_blocking);
void atg_copy_sparse_to_sparse_(tensor *, tensor self, tensor src, int non_blocking);
void atg_copy_sparse_to_sparse_functional(tensor *, tensor self, tensor src, int non_blocking);
...
void atg_eig_e(tensor *, tensor e, tensor v, tensor self, int eigenvectors);
void atg_einsum(tensor *, char * equation, tensor *tensors_data, int tensors_len);
...
void atg_embedding_bag_padding_idx(tensor *, tensor weight, tensor indices, tensor offsets, int scale_grad_by_freq, int64_t mode, int sparse, tensor per_sample_weights, int include_last_offset, int64_t padding_idx);
...
void atg_embedding_renorm(tensor *, tensor out, tensor self, tensor indices, double max_norm, double norm_type);
void atg_embedding_renorm_(tensor *, tensor self, tensor indices, double max_norm, double norm_type);
void atg_embedding_renorm_functional(tensor *, tensor self, tensor indices, double max_norm, double norm_type);
...
void atg_exponential(tensor *, tensor out, tensor self, double lambd);
void atg_exponential_(tensor *, tensor self, double lambd);
void atg_exponential_functional(tensor *, tensor self, double lambd);
...
void atg_fft_fft(tensor *, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_fft_out(tensor *, tensor out, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_hfft(tensor *, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_hfft_out(tensor *, tensor out, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_ifft(tensor *, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_ifft_out(tensor *, tensor out, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_ihfft(tensor *, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_ihfft_out(tensor *, tensor out, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_irfft(tensor *, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_irfft_out(tensor *, tensor out, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_rfft(tensor *, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_fft_rfft_out(tensor *, tensor out, tensor self, int64_t n, int64_t dim, char * norm);
...
void atg_from_file(tensor *, char * filename, int shared, int64_t size, int options_kind, int options_device);
...
void atg_geometric(tensor *, tensor out, tensor self, double p);
void atg_geometric_(tensor *, tensor self, double p);
void atg_geometric_functional(tensor *, tensor self, double p);
...
void atg_im2col_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *input_size_data, int input_size_len, int64_t *kernel_size_data, int kernel_size_len, int64_t *dilation_data, int dilation_len, int64_t *padding_data, int padding_len, int64_t *stride_data, int stride_len);
...
void atg_istft(tensor *, tensor self, int64_t n_fft, int64_t hop_length, int64_t win_length, tensor window, int center, int normalized, int onesided, int64_t length, int return_complex);
...
void atg_l1_loss_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, tensor target, int64_t reduction);
...
void atg_linalg_inv(tensor *, tensor self);
void atg_linalg_inv_ex(tensor *, tensor self, int check_errors);
void atg_linalg_inv_ex_inverse(tensor *, tensor inverse, tensor info, tensor self, int check_errors);
...
void atg_linalg_lstsq(tensor *, tensor self, tensor b, double rcond, char * driver);
void atg_linalg_lstsq_out(tensor *, tensor solution, tensor residuals, tensor rank, tensor singular_values, tensor self, tensor b, double rcond, char * driver);
...
void atg_linalg_matrix_rank_atol_rtol_float(tensor *, tensor self, double atol, double rtol, int hermitian);
void atg_linalg_matrix_rank_atol_rtol_float_out(tensor *, tensor out, tensor self, double atol, double rtol, int hermitian);
...
void atg_linalg_pinv_atol_rtol_float(tensor *, tensor self, double atol, double rtol, int hermitian);
void atg_linalg_pinv_atol_rtol_float_out(tensor *, tensor out, tensor self, double atol, double rtol, int hermitian);
...
void atg_linalg_slogdet(tensor *, tensor self);
...
void atg_linalg_vander(tensor *, tensor x, int64_t n);
...
void atg_log_normal(tensor *, tensor out, tensor self, double mean, double std);
void atg_log_normal_(tensor *, tensor self, double mean, double std);
void atg_log_normal_functional(tensor *, tensor self, double mean, double std);
...
void atg_logit(tensor *, tensor self, double eps);
void atg_logit_(tensor *, tensor self, double eps);
void atg_logit_backward(tensor *, tensor grad_output, tensor self, double eps);
void atg_logit_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, tensor self, double eps);
void atg_logit_out(tensor *, tensor out, tensor self, double eps);
...
void atg_lstsq_x(tensor *, tensor X, tensor qr, tensor self, tensor A);
...
void atg_matrix_rank_tol(tensor *, tensor self, double tol, int symmetric);
...
void atg_nan_to_num(tensor *, tensor self, double nan, double posinf, double neginf);
void atg_nan_to_num_(tensor *, tensor self, double nan, double posinf, double neginf);
void atg_nan_to_num_out(tensor *, tensor out, tensor self, double nan, double posinf, double neginf);
...
void atg_nanquantile(tensor *, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation);
void atg_nanquantile_out(tensor *, tensor out, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation);
void atg_nanquantile_scalar(tensor *, tensor self, double q, int64_t dim, int keepdim, char * interpolation);
void atg_nanquantile_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim, int keepdim, char * interpolation);
...
void atg_nested_tensor(tensor *, tensor *list_data, int list_len, int dtype, int device, int pin_memory);
...
void atg_normal(tensor *, tensor out, tensor mean, double std);
void atg_normal_(tensor *, tensor self, double mean, double std);
void atg_normal_float_float_out(tensor *, tensor out, double mean, double std, int64_t *size_data, int size_len);
void atg_normal_float_tensor_out(tensor *, tensor out, double mean, tensor std);
void atg_normal_functional(tensor *, tensor self, double mean, double std);
void atg_normal_out(tensor *, tensor out, tensor self, double mean, double std);
void atg_normal_tensor_tensor_out(tensor *, tensor out, tensor mean, tensor std);
...
void atg_pad(tensor *, tensor self, int64_t *pad_data, int pad_len, char * mode, double value);
...
void atg_quantile(tensor *, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation);
void atg_quantile_out(tensor *, tensor out, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation);
void atg_quantile_scalar(tensor *, tensor self, double q, int64_t dim, int keepdim, char * interpolation);
void atg_quantile_scalar_out(tensor *, tensor out, tensor self, double q, int64_t dim, int keepdim, char * interpolation);
...
void atg_random(tensor *, tensor out, tensor self);
void atg_random_(tensor *, tensor self);
void atg_random_from_(tensor *, tensor self, int64_t from, int64_t to);
void atg_random_from_functional(tensor *, tensor self, int64_t from, int64_t to);
void atg_random_from_out(tensor *, tensor out, tensor self, int64_t from, int64_t to);
void atg_random_functional(tensor *, tensor self);
void atg_random_to_(tensor *, tensor self, int64_t to);
void atg_random_to_functional(tensor *, tensor self, int64_t to);
...
void atg_repeat_interleave(tensor *, tensor repeats, int64_t output_size);
void atg_repeat_interleave_self_int(tensor *, tensor self, int64_t repeats, int64_t dim, int64_t output_size);
void atg_repeat_interleave_self_tensor(tensor *, tensor self, tensor repeats, int64_t dim, int64_t output_size);
...
void atg_resize(tensor *, tensor out, tensor self, int64_t *size_data, int size_len);
void atg_resize_(tensor *, tensor self, int64_t *size_data, int size_len);
void atg_resize_as(tensor *, tensor out, tensor self, tensor the_template);
void atg_resize_as_(tensor *, tensor self, tensor the_template);
void atg_resize_as_functional(tensor *, tensor self, tensor the_template);
void atg_resize_as_sparse(tensor *, tensor out, tensor self, tensor the_template);
void atg_resize_as_sparse_(tensor *, tensor self, tensor the_template);
void atg_resize_as_sparse_functional(tensor *, tensor self, tensor the_template);
void atg_resize_functional(tensor *, tensor self, int64_t *size_data, int size_len);
...
void atg_segment_reduce(tensor *, tensor data, char * reduce, tensor lengths, tensor indices, int64_t axis, int unsafe, scalar initial);
...
void atg_set(tensor *, tensor out, tensor self);
void atg_set_(tensor *, tensor self);
void atg_set_functional(tensor *, tensor self);
void atg_set_requires_grad(tensor *, tensor self, int r);
void atg_set_source_tensor_(tensor *, tensor self, tensor source);
void atg_set_source_tensor_functional(tensor *, tensor self, tensor source);
...
void atg_slice_copy(tensor *, tensor self, int64_t dim, int64_t start, int64_t end, int64_t step);
void atg_slice_copy_tensor_out(tensor *, tensor out, tensor self, int64_t dim, int64_t start, int64_t end, int64_t step);
void atg_slice_scatter(tensor *, tensor self, tensor src, int64_t dim, int64_t start, int64_t end, int64_t step);
...
void atg_sparse_resize(tensor *, tensor out, tensor self, int64_t *size_data, int size_len, int64_t sparse_dim, int64_t dense_dim);
void atg_sparse_resize_(tensor *, tensor self, int64_t *size_data, int size_len, int64_t sparse_dim, int64_t dense_dim);
void atg_sparse_resize_and_clear(tensor *, tensor out, tensor self, int64_t *size_data, int size_len, int64_t sparse_dim, int64_t dense_dim);
void atg_sparse_resize_and_clear_(tensor *, tensor self, int64_t *size_data, int size_len, int64_t sparse_dim, int64_t dense_dim);
void atg_sparse_resize_and_clear_functional(tensor *, tensor self, int64_t *size_data, int size_len, int64_t sparse_dim, int64_t dense_dim);
void atg_sparse_resize_functional(tensor *, tensor self, int64_t *size_data, int size_len, int64_t sparse_dim, int64_t dense_dim);
...
void atg_special_logit(tensor *, tensor self, double eps);
void atg_special_logit_out(tensor *, tensor out, tensor self, double eps);
...
void atg_split_copy_tensor_out(tensor *, tensor *out_data, int out_len, tensor self, int64_t split_size, int64_t dim);
...
void atg_split_with_sizes_copy_out(tensor *, tensor *out_data, int out_len, tensor self, int64_t *split_sizes_data, int split_sizes_len, int64_t dim);
...
void atg_std_correction(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim);
void atg_std_correction_out(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim);
...
void atg_std_mean_correction(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim);
...
void atg_stft(tensor *, tensor self, int64_t n_fft, int64_t hop_length, int64_t win_length, tensor window, int normalized, int onesided, int return_complex);
void atg_stft_center(tensor *, tensor self, int64_t n_fft, int64_t hop_length, int64_t win_length, tensor window, int center, char * pad_mode, int normalized, int onesided, int return_complex);
...
void atg_take_along_dim(tensor *, tensor self, tensor indices, int64_t dim);
void atg_take_along_dim_out(tensor *, tensor out, tensor self, tensor indices, int64_t dim);
...
void atg_unbind_copy_int_out(tensor *, tensor *out_data, int out_len, tensor self, int64_t dim);
...
void atg_uniform(tensor *, tensor out, tensor self, double from, double to);
void atg_uniform_(tensor *, tensor self, double from, double to);
void atg_uniform_functional(tensor *, tensor self, double from, double to);
...
void atg_upsample_bicubic2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h, double scales_w);
...
void atg_upsample_bilinear2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_h, double scales_w);
...
void atg_upsample_linear1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales);
...
void atg_upsample_nearest1d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales);
...
void atg_upsample_nearest2d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_h, double scales_w);
...
void atg_upsample_nearest3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, double scales_d, double scales_h, double scales_w);
...
void atg_upsample_trilinear3d_backward_grad_input(tensor *, tensor grad_input, tensor grad_output, int64_t *output_size_data, int output_size_len, int64_t *input_size_data, int input_size_len, int align_corners, double scales_d, double scales_h, double scales_w);
...
void atg_vander(tensor *, tensor x, int64_t n, int increasing);
void atg_var(tensor *, tensor self, int unbiased);
void atg_var_correction(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim);
void atg_var_correction_out(tensor *, tensor out, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim);
...
void atg_var_mean_correction(tensor *, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim);
...
void atg_zero(tensor *, tensor out, tensor self);
void atg_zero_(tensor *, tensor self);
void atg_zero_functional(tensor *, tensor self);
