...
void atg__masked_softmax(tensor *, tensor self, tensor mask, int64_t dim_v, int dim_null);
...
void atg_normal(tensor *, tensor self, double mean, double std);
...
void atg_random_from_functional(tensor *, tensor self, int64_t from, int64_t to_v, int to_null);
