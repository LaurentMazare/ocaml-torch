...
void atg_as_strided(tensor *, tensor self, long int *size_data, int size_len, long int *stride_data, int stride_len);
void atg_as_strided1(tensor *, tensor self, long int *size_data, int size_len, long int *stride_data, int stride_len, int64_t storage_offset);
void atg_as_strided_(tensor *, tensor self, long int *size_data, int size_len, long int *stride_data, int stride_len);
void atg_as_strided_1(tensor *, tensor self, long int *size_data, int size_len, long int *stride_data, int stride_len, int64_t storage_offset);
...
void atg_ctc_loss(tensor *, tensor log_probs, tensor targets, long int *input_lengths_data, int input_lengths_len, long int *target_lengths_data, int target_lengths_len, int64_t blank, int64_t reduction);
...
void atg_frobenius_norm1(tensor *, tensor self, long int *dim_data, int dim_len, int keepdim);
...
void atg_pow_out(tensor *, tensor result, tensor self, tensor exponent);
...
void atg_randint(tensor *, int64_t high, long int *size_data, int size_len, int options_kind, int options_device);
void atg_randint1(tensor *, int64_t low, int64_t high, long int *size_data, int size_len, int options_kind, int options_device);
...
void atg_randint_out(tensor *, tensor result, int64_t high, long int *size_data, int size_len);
void atg_randint_out1(tensor *, tensor result, int64_t low, int64_t high, long int *size_data, int size_len);
...
void atg_sparse_coo_tensor2(tensor *, tensor indices, tensor values, long int *size_data, int size_len);
...
void atg_sum2(tensor *, tensor self, long int *dim_data, int dim_len, int keepdim);
void atg_sum3(tensor *, tensor self, long int *dim_data, int dim_len, int dtype);
void atg_sum4(tensor *, tensor self, long int *dim_data, int dim_len, int keepdim, int dtype);
void atg_sum_out(tensor *, tensor result, tensor self, long int *dim_data, int dim_len, int keepdim);
void atg_sum_out1(tensor *, tensor result, tensor self, long int *dim_data, int dim_len, int dtype);
void atg_sum_out2(tensor *, tensor result, tensor self, long int *dim_data, int dim_len, int keepdim, int dtype);
...
void atg_to1(tensor *, tensor self, int dtype, int non_blocking);
void atg_to2(tensor *, tensor self, int device, int non_blocking);
void atg_to3(tensor *, tensor self, tensor other, int non_blocking);
void atg_to4(tensor *, tensor self, int device, int dtype, int non_blocking);
