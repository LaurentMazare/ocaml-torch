...
void atg__sparse_matrix_mask_helper(tensor *out__, tensor t, tensor mask_indices) {
  PROTECT(
    auto outputs__ = torch::_sparse_matrix_mask_helper(*t, *mask_indices);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__syevd_helper(tensor *out__, tensor self, int compute_eigenvectors, char * uplo) {
  PROTECT(
    auto outputs__ = torch::_syevd_helper(*self, (bool)compute_eigenvectors, std::string(uplo));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_bucketize1(tensor *out__, scalar self, tensor boundaries, int out_int32, int right) {
  PROTECT(
    auto outputs__ = torch::bucketize(*self, *boundaries, (bool)out_int32, (bool)right);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_copysign1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::copysign(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_copysign_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->copysign_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_div2(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_div3(tensor *out__, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::div(*self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_div_2(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_div_3(tensor *out__, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = self->div_(*other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_divide2(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_divide3(tensor *out__, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = torch::divide(*self, *other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_divide_2(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_divide_3(tensor *out__, tensor self, scalar other, char * rounding_mode) {
  PROTECT(
    auto outputs__ = self->divide_(*other, std::string(rounding_mode));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_float_power1(tensor *out__, scalar self, tensor exponent) {
  PROTECT(
    auto outputs__ = torch::float_power(*self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_float_power2(tensor *out__, tensor self, scalar exponent) {
  PROTECT(
    auto outputs__ = torch::float_power(*self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_float_power_1(tensor *out__, tensor self, tensor exponent) {
  PROTECT(
    auto outputs__ = self->float_power_(*exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_float_power_out1(tensor *out__, tensor out, scalar self, tensor exponent) {
  PROTECT(
    auto outputs__ = torch::float_power_out(*out, *self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_float_power_out2(tensor *out__, tensor out, tensor self, scalar exponent) {
  PROTECT(
    auto outputs__ = torch::float_power_out(*out, *self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_linalg_norm(tensor *out__, tensor self, scalar ord, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::linalg_norm(*self, *ord, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_norm1(tensor *out__, tensor self, char * ord, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::linalg_norm(*self, std::string(ord), torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_linalg_norm_out(tensor *out__, tensor out, tensor self, scalar ord, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::linalg_norm_out(*out, *self, *ord, torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_norm_out1(tensor *out__, tensor out, tensor self, char * ord, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::linalg_norm_out(*out, *self, std::string(ord), torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_linalg_svd(tensor *out__, tensor self, int full_matrices, int compute_uv) {
  PROTECT(
    auto outputs__ = torch::linalg_svd(*self, (bool)full_matrices, (bool)compute_uv);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg_linalg_svd_out(tensor *out__, tensor U, tensor S, tensor V, tensor self, int full_matrices, int compute_uv) {
  PROTECT(
    auto outputs__ = torch::linalg_svd_out(*U, *S, *V, *self, (bool)full_matrices, (bool)compute_uv);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg_pow_out1(tensor *out__, tensor out, scalar self, tensor exponent) {
  PROTECT(
    auto outputs__ = torch::pow_out(*out, *self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_pow_out2(tensor *out__, tensor out, tensor self, scalar exponent) {
  PROTECT(
    auto outputs__ = torch::pow_out(*out, *self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_scatter_2(tensor *out__, tensor self, int64_t dim, tensor index, tensor src, char * reduce) {
  PROTECT(
...
void atg_scatter_3(tensor *out__, tensor self, int64_t dim, tensor index, scalar value, char * reduce) {
  PROTECT(
...
void atg_searchsorted1(tensor *out__, tensor sorted_sequence, scalar self, int out_int32, int right) {
  PROTECT(
    auto outputs__ = torch::searchsorted(*sorted_sequence, *self, (bool)out_int32, (bool)right);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_where2(tensor *out__, tensor condition, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::where(*condition, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_where4(tensor *out__, tensor condition, scalar self, scalar other) {
  PROTECT(
    auto outputs__ = torch::where(*condition, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_xlogy1(tensor *out__, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::xlogy(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_xlogy2(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::xlogy(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_xlogy_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::xlogy_(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_xlogy_out1(tensor *out__, tensor out, scalar self, tensor other) {
  PROTECT(
    auto outputs__ = torch::xlogy_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_xlogy_out2(tensor *out__, tensor out, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::xlogy_out(*out, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
