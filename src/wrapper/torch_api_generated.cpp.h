...
void atg___and__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___iand__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___ilshift__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___ior__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___irshift__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___ixor__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___lshift__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___or__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___rshift__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg___xor__(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg__linalg_solve_out_helper_(tensor *out__, tensor self, tensor other, tensor infos) {
  PROTECT(
    auto outputs__ = torch::_linalg_solve_out_helper_(*self, *other, *infos);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__sparse_csr_tensor(tensor *out__, tensor crow_indices, tensor col_indices, tensor values, int options_kind, int options_device) {
  PROTECT(
    auto outputs__ = torch::_sparse_csr_tensor(*crow_indices, *col_indices, *values, at::device(device_of_int(options_device)).dtype(at::ScalarType(options_kind)));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg__sparse_csr_tensor1(tensor *out__, tensor crow_indices, tensor col_indices, tensor values, int64_t *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
    auto outputs__ = torch::_sparse_csr_tensor(*crow_indices, *col_indices, *values, torch::IntArrayRef(size_data, size_len), at::device(device_of_int(options_device)).dtype(at::ScalarType(options_kind)));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg__test_ambiguous_defaults1(tensor *out__, tensor dummy, int64_t a, char * b) {
  PROTECT(
...
void atg_bitwise_and(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_bitwise_and_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_bitwise_or(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_bitwise_or_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_bitwise_xor(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_bitwise_xor_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_clamp1(tensor *out__, tensor self, tensor min, tensor max) {
  PROTECT(
...
void atg_clamp_1(tensor *out__, tensor self, tensor min, tensor max) {
  PROTECT(
...
void atg_clamp_max(tensor *out__, tensor self, tensor max) {
  PROTECT(
...
void atg_clamp_max_(tensor *out__, tensor self, tensor max) {
  PROTECT(
...
void atg_clamp_max_out(tensor *out__, tensor out, tensor self, tensor max) {
  PROTECT(
...
void atg_clamp_min(tensor *out__, tensor self, tensor min) {
  PROTECT(
...
void atg_clamp_min_(tensor *out__, tensor self, tensor min) {
  PROTECT(
...
void atg_clamp_min_out(tensor *out__, tensor out, tensor self, tensor min) {
  PROTECT(
...
void atg_clamp_out(tensor *out__, tensor out, tensor self) {
  PROTECT(
    auto outputs__ = torch::clamp_out(*out, *self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_clamp_out1(tensor *out__, tensor out, tensor self, tensor min, tensor max) {
  PROTECT(
...
void atg_clip(tensor *out__, tensor self) {
  PROTECT(
    auto outputs__ = torch::clip(*self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_clip1(tensor *out__, tensor self, tensor min, tensor max) {
  PROTECT(
...
void atg_clip_(tensor *out__, tensor self) {
  PROTECT(
    auto outputs__ = torch::clip_(*self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_clip_1(tensor *out__, tensor self, tensor min, tensor max) {
  PROTECT(
...
void atg_clip_out(tensor *out__, tensor out, tensor self) {
  PROTECT(
    auto outputs__ = torch::clip_out(*out, *self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_clip_out1(tensor *out__, tensor out, tensor self, tensor min, tensor max) {
  PROTECT(
...
void atg_conv1d1(tensor *out__, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
...
void atg_conv2d1(tensor *out__, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
...
void atg_conv3d1(tensor *out__, tensor input, tensor weight, tensor bias, int64_t *stride_data, int stride_len, char * padding, int64_t *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
...
void atg_conv_depthwise3d_backward_out(tensor *out__, tensor grad_input, tensor grad_weight, tensor grad_bias, tensor grad_output, tensor self, tensor weight, int64_t *kernel_size_data, int kernel_size_len, int64_t *stride_data, int stride_len, int64_t *padding_data, int padding_len, int64_t *dilation_data, int dilation_len) {
  PROTECT(
    auto outputs__ = torch::conv_depthwise3d_backward_out(*grad_input, *grad_weight, *grad_bias, *grad_output, *self, *weight, torch::IntArrayRef(kernel_size_data, kernel_size_len), torch::IntArrayRef(stride_data, stride_len), torch::IntArrayRef(padding_data, padding_len), torch::IntArrayRef(dilation_data, dilation_len));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg_cross_entropy_loss(tensor *out__, tensor self, tensor target, tensor weight, int64_t reduction, int64_t ignore_index) {
  PROTECT(
    auto outputs__ = torch::cross_entropy_loss(*self, *target, (weight ? *weight : torch::Tensor()), reduction, ignore_index);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_div1(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_div_1(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_div_out1(tensor *out__, tensor out, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_divide1(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_divide_1(tensor *out__, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
void atg_divide_out1(tensor *out__, tensor out, tensor self, tensor other, char * rounding_mode) {
  PROTECT(
...
tensor *atg_dsplit1(tensor self, int64_t *indices_data, int indices_len) {
  PROTECT(
...
void atg_embedding_bag1(tensor *out__, tensor weight, tensor indices, tensor offsets, int scale_grad_by_freq, int64_t mode, int sparse, tensor per_sample_weights, int include_last_offset, int64_t padding_idx) {
  PROTECT(
...
void atg_eq_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_float_power_(tensor *out__, tensor self, tensor exponent) {
  PROTECT(
...
void atg_float_power_out(tensor *out__, tensor out, tensor self, tensor exponent) {
  PROTECT(
...
void atg_fmod_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_frexp_out(tensor *out__, tensor mantissa, tensor exponent, tensor self) {
  PROTECT(
...
void atg_ge_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_greater(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_greater_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_greater_equal(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_greater_equal_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_greater_equal_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_greater_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_gt_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
tensor *atg_hsplit1(tensor self, int64_t *indices_data, int indices_len) {
  PROTECT(
...
void atg_index_fill(tensor *out__, tensor self, int64_t dim, tensor index, tensor value) {
  PROTECT(
...
void atg_le_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_lerp(tensor *out__, tensor self, tensor end, tensor weight) {
  PROTECT(
...
void atg_lerp_(tensor *out__, tensor self, tensor end, tensor weight) {
  PROTECT(
...
void atg_lerp_out(tensor *out__, tensor out, tensor self, tensor end, tensor weight) {
  PROTECT(
...
void atg_less(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_less_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_less_equal(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_less_equal_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_less_equal_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_less_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_linalg_cholesky(tensor *out__, tensor self) {
  PROTECT(
    auto outputs__ = torch::linalg_cholesky(*self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_cholesky_ex(tensor *out__, tensor self, int check_errors) {
  PROTECT(
    auto outputs__ = torch::linalg_cholesky_ex(*self, (bool)check_errors);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_linalg_cholesky_ex_out(tensor *out__, tensor L, tensor info, tensor self, int check_errors) {
  PROTECT(
    auto outputs__ = torch::linalg_cholesky_ex_out(*L, *info, *self, (bool)check_errors);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_linalg_cholesky_out(tensor *out__, tensor out, tensor self) {
  PROTECT(
    auto outputs__ = torch::linalg_cholesky_out(*out, *self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_cond(tensor *out__, tensor self) {
  PROTECT(
    auto outputs__ = torch::linalg_cond(*self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_cond1(tensor *out__, tensor self, char * p) {
  PROTECT(
...
void atg_linalg_cond_out(tensor *out__, tensor out, tensor self) {
  PROTECT(
    auto outputs__ = torch::linalg_cond_out(*out, *self);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_cond_out1(tensor *out__, tensor out, tensor self, char * p) {
  PROTECT(
...
void atg_linalg_eigh_out(tensor *out__, tensor eigvals, tensor eigvecs, tensor self, char * UPLO) {
  PROTECT(
...
void atg_linalg_inv_ex_out(tensor *out__, tensor inverse, tensor info, tensor self, int check_errors) {
  PROTECT(
...
void atg_linalg_matrix_norm(tensor *out__, tensor self, char * ord, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::linalg_matrix_norm(*self, std::string(ord), torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_matrix_norm_out(tensor *out__, tensor out, tensor self, char * ord, int64_t *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
    auto outputs__ = torch::linalg_matrix_norm_out(*out, *self, std::string(ord), torch::IntArrayRef(dim_data, dim_len), (bool)keepdim, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_linalg_matrix_rank1(tensor *out__, tensor input, tensor tol, int hermitian) {
  PROTECT(
...
void atg_linalg_matrix_rank_out1(tensor *out__, tensor out, tensor input, tensor tol, int hermitian) {
  PROTECT(
...
void atg_linalg_pinv1(tensor *out__, tensor self, tensor rcond, int hermitian) {
  PROTECT(
    auto outputs__ = torch::linalg_pinv(*self, *rcond, (bool)hermitian);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_linalg_pinv_out1(tensor *out__, tensor out, tensor self, tensor rcond, int hermitian) {
  PROTECT(
    auto outputs__ = torch::linalg_pinv_out(*out, *self, *rcond, (bool)hermitian);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_linalg_qr(tensor *out__, tensor self, char * mode) {
  PROTECT(
    auto outputs__ = torch::linalg_qr(*self, std::string(mode));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_linalg_qr_out(tensor *out__, tensor Q, tensor R, tensor self, char * mode) {
  PROTECT(
    auto outputs__ = torch::linalg_qr_out(*Q, *R, *self, std::string(mode));
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_linalg_svd(tensor *out__, tensor self, int full_matrices) {
  PROTECT(
    auto outputs__ = torch::linalg_svd(*self, (bool)full_matrices);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg_linalg_svd_out(tensor *out__, tensor U, tensor S, tensor Vh, tensor self, int full_matrices) {
  PROTECT(
    auto outputs__ = torch::linalg_svd_out(*U, *S, *Vh, *self, (bool)full_matrices);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
    out__[2] = new torch::Tensor(std::get<2>(outputs__));
  )
...
void atg_linalg_svdvals(tensor *out__, tensor input) {
  PROTECT(
    auto outputs__ = torch::linalg_svdvals(*input);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_linalg_svdvals_out(tensor *out__, tensor out, tensor input) {
  PROTECT(
    auto outputs__ = torch::linalg_svdvals_out(*out, *input);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_logit_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, double eps) {
  PROTECT(
...
void atg_lt_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_masked_fill(tensor *out__, tensor self, tensor mask, tensor value) {
  PROTECT(
...
void atg_moveaxis1(tensor *out__, tensor self, int64_t source, int64_t destination) {
  PROTECT(
...
void atg_nanmedian1(tensor *out__, tensor self, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_nanmedian_out(tensor *out__, tensor values, tensor indices, tensor self, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_nanquantile(tensor *out__, tensor self, double q, int64_t dim, int keepdim) {
  PROTECT(
    auto outputs__ = torch::nanquantile(*self, q, dim, (bool)keepdim);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_nanquantile1(tensor *out__, tensor self, tensor q, int64_t dim, int keepdim) {
  PROTECT(
    auto outputs__ = torch::nanquantile(*self, *q, dim, (bool)keepdim);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_nanquantile2(tensor *out__, tensor self, double q, int64_t dim, int keepdim, char * interpolation) {
  PROTECT(
...
void atg_nanquantile3(tensor *out__, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::nanquantile(*self, *q, dim, (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_nanquantile_out(tensor *out__, tensor out, tensor self, double q, int64_t dim, int keepdim) {
  PROTECT(
    auto outputs__ = torch::nanquantile_out(*out, *self, q, dim, (bool)keepdim);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_nanquantile_out1(tensor *out__, tensor out, tensor self, tensor q, int64_t dim, int keepdim) {
  PROTECT(
    auto outputs__ = torch::nanquantile_out(*out, *self, *q, dim, (bool)keepdim);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_nanquantile_out2(tensor *out__, tensor out, tensor self, double q, int64_t dim, int keepdim, char * interpolation) {
  PROTECT(
...
void atg_nanquantile_out3(tensor *out__, tensor out, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::nanquantile_out(*out, *self, *q, dim, (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_nansum(tensor *out__, tensor self, int dtype) {
  PROTECT(
    auto outputs__ = torch::nansum(*self, torch::ScalarType(dtype));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_ne_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_not_equal(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_not_equal_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_not_equal_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_pow_out(tensor *out__, tensor out, tensor self, tensor exponent) {
  PROTECT(
...
void atg_quantile(tensor *out__, tensor self, double q, int64_t dim, int keepdim) {
  PROTECT(
    auto outputs__ = torch::quantile(*self, q, dim, (bool)keepdim);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_quantile1(tensor *out__, tensor self, tensor q, int64_t dim, int keepdim) {
  PROTECT(
    auto outputs__ = torch::quantile(*self, *q, dim, (bool)keepdim);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_quantile2(tensor *out__, tensor self, double q, int64_t dim, int keepdim, char * interpolation) {
  PROTECT(
...
void atg_quantile3(tensor *out__, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::quantile(*self, *q, dim, (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_quantile_out(tensor *out__, tensor out, tensor self, double q, int64_t dim, int keepdim) {
  PROTECT(
    auto outputs__ = torch::quantile_out(*out, *self, q, dim, (bool)keepdim);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_quantile_out1(tensor *out__, tensor out, tensor self, tensor q, int64_t dim, int keepdim) {
  PROTECT(
    auto outputs__ = torch::quantile_out(*out, *self, *q, dim, (bool)keepdim);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_quantile_out2(tensor *out__, tensor out, tensor self, double q, int64_t dim, int keepdim, char * interpolation) {
  PROTECT(
...
void atg_quantile_out3(tensor *out__, tensor out, tensor self, tensor q, int64_t dim, int keepdim, char * interpolation) {
  PROTECT(
    auto outputs__ = torch::quantile_out(*out, *self, *q, dim, (bool)keepdim, std::string(interpolation));
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_remainder_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
...
void atg_scatter_1(tensor *out__, tensor self, int64_t dim, tensor index, tensor src, char * reduce) {
  PROTECT(
...
void atg_segment_reduce(tensor *out__, tensor data, char * reduce, tensor lengths, tensor indices, int64_t axis, int unsafe) {
  PROTECT(
    auto outputs__ = torch::segment_reduce(*data, std::string(reduce), (lengths ? *lengths : torch::Tensor()), (indices ? *indices : torch::Tensor()), axis, (bool)unsafe);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_segment_reduce_backward(tensor *out__, tensor grad, tensor output, tensor data, tensor lengths) {
  PROTECT(
    auto outputs__ = torch::segment_reduce_backward(*grad, *output, *data, (lengths ? *lengths : torch::Tensor()));
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_sort1(tensor *out__, tensor self, int stable, int64_t dim, int descending) {
  PROTECT(
...
void atg_sort_out1(tensor *out__, tensor values, tensor indices, tensor self, int stable, int64_t dim, int descending) {
  PROTECT(
...
void atg_std2(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim) {
  PROTECT(
...
void atg_std_mean2(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim) {
  PROTECT(
...
void atg_std_out1(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim) {
  PROTECT(
...
tensor *atg_tensor_split1(tensor self, int64_t *indices_data, int indices_len, int64_t dim) {
  PROTECT(
...
tensor *atg_tensor_split2(tensor self, tensor tensor_indices_or_sections, int64_t dim) {
  PROTECT(
...
void atg_var2(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim) {
  PROTECT(
...
void atg_var_mean2(tensor *out__, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim) {
  PROTECT(
...
void atg_var_out1(tensor *out__, tensor out, tensor self, int64_t *dim_data, int dim_len, int64_t correction, int keepdim) {
  PROTECT(
...
void atg_view1(tensor *out__, tensor self, int dtype) {
  PROTECT(
...
tensor *atg_vsplit1(tensor self, int64_t *indices_data, int indices_len) {
  PROTECT(
...
void atg_xlogy_out(tensor *out__, tensor out, tensor self, tensor other) {
  PROTECT(
