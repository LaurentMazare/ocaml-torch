...
void atg_to_sparse(tensor *out__, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
    auto outputs__ = self->to_sparse(blocksize_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(blocksize_data, blocksize_len)), dense_dim_null ? c10::nullopt : c10::optional<int64_t>(dense_dim_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_to_sparse_bsc(tensor *out__, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg_to_sparse_bsc_out(tensor *out__, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg_to_sparse_bsr(tensor *out__, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg_to_sparse_bsr_out(tensor *out__, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg_to_sparse_csc(tensor *out__, tensor self, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg_to_sparse_csc_out(tensor *out__, tensor out, tensor self, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg_to_sparse_csr(tensor *out__, tensor self, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg_to_sparse_csr_out(tensor *out__, tensor out, tensor self, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
...
void atg_to_sparse_out(tensor *out__, tensor out, tensor self, int64_t *blocksize_data, int blocksize_len, int64_t dense_dim_v, int dense_dim_null) {
  PROTECT(
    auto outputs__ = torch::to_sparse_out(*out, *self, blocksize_data == nullptr ? c10::nullopt : c10::optional<torch::IntArrayRef>(torch::IntArrayRef(blocksize_data, blocksize_len)), dense_dim_null ? c10::nullopt : c10::optional<int64_t>(dense_dim_v));
    out__[0] = new torch::Tensor(outputs__);
  )
}
