...
void atg_adaptive_avg_pool1d(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_adaptive_avg_pool2d(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_adaptive_avg_pool2d_forward(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::adaptive_avg_pool2d_forward(*self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_adaptive_avg_pool2d_forward_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::adaptive_avg_pool2d_forward_out(*output, *self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_adaptive_avg_pool2d_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_adaptive_avg_pool3d(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_adaptive_avg_pool3d_forward(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::adaptive_avg_pool3d_forward(*self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_adaptive_avg_pool3d_forward_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::adaptive_avg_pool3d_forward_out(*output, *self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_adaptive_avg_pool3d_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_adaptive_max_pool1d(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_all2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_any2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_arange3(tensor *out__, scalar end, int options_kind, int options_device) {
  PROTECT(
...
void atg_arange_out3(tensor *out__, tensor result, scalar end) {
  PROTECT(
...
void atg_argmax2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_argmin2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_as_strided1(tensor *out__, tensor self, long int *size_data, int size_len, long int *stride_data, int stride_len) {
  PROTECT(
...
void atg_as_strided2(tensor *out__, tensor self, long int *size_data, int size_len, long int *stride_data, int stride_len, int64_t storage_offset) {
  PROTECT(
...
void atg_as_strided_1(tensor *out__, tensor self, long int *size_data, int size_len, long int *stride_data, int stride_len) {
  PROTECT(
...
void atg_as_strided_2(tensor *out__, tensor self, long int *size_data, int size_len, long int *stride_data, int stride_len, int64_t storage_offset) {
  PROTECT(
...
void atg_avg_pool1d(tensor *out__, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_avg_pool2d(tensor *out__, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_avg_pool2d_backward(tensor *out__, tensor grad_output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_avg_pool2d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_avg_pool2d_forward(tensor *out__, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
    auto outputs__ = torch::avg_pool2d_forward(*self, torch::IntList(kernel_size_data, kernel_size_len), torch::IntList(stride_data, stride_len), torch::IntList(padding_data, padding_len), (bool)ceil_mode, (bool)count_include_pad);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_avg_pool2d_forward_out(tensor *out__, tensor output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
    auto outputs__ = torch::avg_pool2d_forward_out(*output, *self, torch::IntList(kernel_size_data, kernel_size_len), torch::IntList(stride_data, stride_len), torch::IntList(padding_data, padding_len), (bool)ceil_mode, (bool)count_include_pad);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_avg_pool2d_out(tensor *out__, tensor output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_avg_pool3d(tensor *out__, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_avg_pool3d_backward(tensor *out__, tensor grad_output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_avg_pool3d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_avg_pool3d_forward(tensor *out__, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
    auto outputs__ = torch::avg_pool3d_forward(*self, torch::IntList(kernel_size_data, kernel_size_len), torch::IntList(stride_data, stride_len), torch::IntList(padding_data, padding_len), (bool)ceil_mode, (bool)count_include_pad);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_avg_pool3d_forward_out(tensor *out__, tensor output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
    auto outputs__ = torch::avg_pool3d_forward_out(*output, *self, torch::IntList(kernel_size_data, kernel_size_len), torch::IntList(stride_data, stride_len), torch::IntList(padding_data, padding_len), (bool)ceil_mode, (bool)count_include_pad);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_avg_pool3d_out(tensor *out__, tensor output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, int ceil_mode, int count_include_pad) {
  PROTECT(
...
void atg_bartlett_window1(tensor *out__, int64_t window_length, int options_kind, int options_device) {
  PROTECT(
...
void atg_bartlett_window2(tensor *out__, int64_t window_length, int periodic, int options_kind, int options_device) {
  PROTECT(
...
void atg_bernoulli1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_bernoulli2(tensor *out__, tensor self, double p) {
  PROTECT(
...
void atg_binary_cross_entropy_forward(tensor *out__, tensor self, tensor target, tensor weight, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::binary_cross_entropy_forward(*self, *target, (weight ? *weight : torch::Tensor()), reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_binary_cross_entropy_forward_out(tensor *out__, tensor output, tensor self, tensor target, tensor weight, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::binary_cross_entropy_forward_out(*output, *self, *target, (weight ? *weight : torch::Tensor()), reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_blackman_window1(tensor *out__, int64_t window_length, int options_kind, int options_device) {
  PROTECT(
...
void atg_blackman_window2(tensor *out__, int64_t window_length, int periodic, int options_kind, int options_device) {
  PROTECT(
...
void atg_constant_pad_nd(tensor *out__, tensor self, long int *pad_data, int pad_len) {
  PROTECT(
...
void atg_conv1d(tensor *out__, tensor input, tensor weight, tensor bias, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
...
void atg_conv2d(tensor *out__, tensor input, tensor weight, tensor bias, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
...
void atg_conv3d(tensor *out__, tensor input, tensor weight, tensor bias, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
...
void atg_conv_transpose1d(tensor *out__, tensor input, tensor weight, tensor bias, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *output_padding_data, int output_padding_len, int64_t groups, long int *dilation_data, int dilation_len) {
  PROTECT(
...
void atg_conv_transpose2d(tensor *out__, tensor input, tensor weight, tensor bias, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *output_padding_data, int output_padding_len, int64_t groups, long int *dilation_data, int dilation_len) {
  PROTECT(
...
void atg_conv_transpose3d(tensor *out__, tensor input, tensor weight, tensor bias, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *output_padding_data, int output_padding_len, int64_t groups, long int *dilation_data, int dilation_len) {
  PROTECT(
...
void atg_convolution(tensor *out__, tensor input, tensor weight, tensor bias, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int transposed, long int *output_padding_data, int output_padding_len, int64_t groups) {
  PROTECT(
...
void atg_ctc_loss1(tensor *out__, tensor log_probs, tensor targets, long int *input_lengths_data, int input_lengths_len, long int *target_lengths_data, int target_lengths_len, int64_t blank, int64_t reduction) {
  PROTECT(
...
void atg_ctc_loss2(tensor *out__, tensor log_probs, tensor targets, tensor input_lengths, tensor target_lengths, int64_t blank, int64_t reduction) {
  PROTECT(
...
void atg_cudnn_convolution(tensor *out__, tensor self, tensor weight, tensor bias, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_cudnn_convolution_backward_input(tensor *out__, long int *self_size_data, int self_size_len, tensor grad_output, tensor weight, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_cudnn_convolution_backward_weight(tensor *out__, long int *weight_size_data, int weight_size_len, tensor grad_output, tensor self, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_cudnn_convolution_transpose(tensor *out__, tensor self, tensor weight, tensor bias, long int *padding_data, int padding_len, long int *output_padding_data, int output_padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_cudnn_convolution_transpose_backward_input(tensor *out__, tensor grad_output, tensor weight, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_cudnn_convolution_transpose_backward_weight(tensor *out__, long int *weight_size_data, int weight_size_len, tensor grad_output, tensor self, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_cumprod2(tensor *out__, tensor self, int64_t dim) {
  PROTECT(
...
void atg_cumprod_out2(tensor *out__, tensor result, tensor self, int64_t dim) {
  PROTECT(
...
void atg_cumsum2(tensor *out__, tensor self, int64_t dim) {
  PROTECT(
...
void atg_cumsum_out2(tensor *out__, tensor result, tensor self, int64_t dim) {
  PROTECT(
...
void atg_empty(tensor *out__, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_empty_like1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_empty_like2(tensor *out__, tensor self, int options_kind, int options_device) {
  PROTECT(
...
void atg_empty_out(tensor *out__, tensor result, long int *size_data, int size_len) {
  PROTECT(
...
void atg_empty_strided(tensor *out__, long int *size_data, int size_len, long int *stride_data, int stride_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_eq(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_eq1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::eq(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_eq_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_eq_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->eq_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_eq_out1(tensor *out__, tensor result, tensor self, scalar other) {
  PROTECT(
...
void atg_eq_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
    auto outputs__ = torch::eq_out(*result, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_expand(tensor *out__, tensor self, long int *size_data, int size_len, int implicit) {
  PROTECT(
...
void atg_eye1(tensor *out__, int64_t n, int options_kind, int options_device) {
  PROTECT(
...
void atg_eye2(tensor *out__, int64_t n, int64_t m, int options_kind, int options_device) {
  PROTECT(
...
void atg_eye_out1(tensor *out__, tensor result, int64_t n) {
  PROTECT(
...
void atg_eye_out2(tensor *out__, tensor result, int64_t n, int64_t m) {
  PROTECT(
...
void atg_fill_(tensor *out__, tensor self, tensor value) {
  PROTECT(
...
void atg_fill_1(tensor *out__, tensor self, scalar value) {
  PROTECT(
    auto outputs__ = torch::fill_(*self, *value);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_flip(tensor *out__, tensor self, long int *dims_data, int dims_len) {
  PROTECT(
...
void atg_fmod(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_fmod1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::fmod(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_fmod_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_fmod_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->fmod_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_fmod_out1(tensor *out__, tensor result, tensor self, scalar other) {
  PROTECT(
...
void atg_fmod_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
    auto outputs__ = torch::fmod_out(*result, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_fractional_max_pool2d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *output_size_data, int output_size_len, tensor indices) {
  PROTECT(
...
void atg_frobenius_norm1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_frobenius_norm2(tensor *out__, tensor self, long int *dim_data, int dim_len, int keepdim) {
  PROTECT(
...
void atg_frobenius_norm_out(tensor *out__, tensor result, tensor self, long int *dim_data, int dim_len, int keepdim) {
  PROTECT(
...
void atg_full(tensor *out__, long int *size_data, int size_len, scalar fill_value, int options_kind, int options_device) {
  PROTECT(
...
void atg_full_like1(tensor *out__, tensor self, scalar fill_value) {
  PROTECT(
...
void atg_full_like2(tensor *out__, tensor self, scalar fill_value, int options_kind, int options_device) {
  PROTECT(
...
void atg_full_out(tensor *out__, tensor result, long int *size_data, int size_len, scalar fill_value) {
  PROTECT(
...
void atg_ge(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_ge1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::ge(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_ge_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_ge_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->ge_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_ge_out1(tensor *out__, tensor result, tensor self, scalar other) {
  PROTECT(
...
void atg_ge_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
    auto outputs__ = torch::ge_out(*result, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_glu_forward(tensor *out__, tensor self, int64_t dim) {
  PROTECT(
    auto outputs__ = torch::glu_forward(*self, dim);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_glu_forward_out(tensor *out__, tensor output, tensor self, int64_t dim) {
  PROTECT(
    auto outputs__ = torch::glu_forward_out(*output, *self, dim);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_gru1(tensor *out__, tensor input, tensor hx, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional, int batch_first) {
  PROTECT(
...
void atg_gru2(tensor *out__, tensor data, tensor batch_sizes, tensor hx, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional) {
  PROTECT(
...
void atg_gt(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_gt1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::gt(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_gt_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_gt_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->gt_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_gt_out1(tensor *out__, tensor result, tensor self, scalar other) {
  PROTECT(
...
void atg_gt_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
    auto outputs__ = torch::gt_out(*result, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_hamming_window1(tensor *out__, int64_t window_length, int options_kind, int options_device) {
  PROTECT(
...
void atg_hamming_window2(tensor *out__, int64_t window_length, int periodic, int options_kind, int options_device) {
  PROTECT(
...
void atg_hamming_window3(tensor *out__, int64_t window_length, int periodic, double alpha, int options_kind, int options_device) {
  PROTECT(
...
void atg_hamming_window4(tensor *out__, int64_t window_length, int periodic, double alpha, double beta, int options_kind, int options_device) {
  PROTECT(
...
void atg_hann_window1(tensor *out__, int64_t window_length, int options_kind, int options_device) {
  PROTECT(
...
void atg_hann_window2(tensor *out__, int64_t window_length, int periodic, int options_kind, int options_device) {
  PROTECT(
...
void atg_index_fill_1(tensor *out__, tensor self, int64_t dim, tensor index, scalar value) {
  PROTECT(
...
void atg_index_fill_2(tensor *out__, tensor self, int64_t dim, tensor index, tensor value) {
  PROTECT(
    auto outputs__ = self->index_fill_(dim, *index, *value);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_irfft(tensor *out__, tensor self, int64_t signal_ndim, int normalized, int onesided, long int *signal_sizes_data, int signal_sizes_len) {
  PROTECT(
...
void atg_l1_loss_forward(tensor *out__, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::l1_loss_forward(*self, *target, reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_l1_loss_forward_out(tensor *out__, tensor output, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::l1_loss_forward_out(*output, *self, *target, reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_layer_norm(tensor *out__, tensor input, long int *normalized_shape_data, int normalized_shape_len, tensor weight, tensor bias, double eps, int cudnn_enable) {
  PROTECT(
...
void atg_le(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_le1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::le(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_le_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_le_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->le_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_le_out1(tensor *out__, tensor result, tensor self, scalar other) {
  PROTECT(
...
void atg_le_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
    auto outputs__ = torch::le_out(*result, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_linspace1(tensor *out__, scalar start, scalar end, int options_kind, int options_device) {
  PROTECT(
...
void atg_linspace2(tensor *out__, scalar start, scalar end, int64_t steps, int options_kind, int options_device) {
  PROTECT(
...
void atg_linspace_out1(tensor *out__, tensor result, scalar start, scalar end) {
  PROTECT(
...
void atg_linspace_out2(tensor *out__, tensor result, scalar start, scalar end, int64_t steps) {
  PROTECT(
...
void atg_log_sigmoid_forward(tensor *out__, tensor self) {
  PROTECT(
    auto outputs__ = torch::log_sigmoid_forward(*self);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_log_sigmoid_forward_out(tensor *out__, tensor output, tensor buffer, tensor self) {
  PROTECT(
    auto outputs__ = torch::log_sigmoid_forward_out(*output, *buffer, *self);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_log_softmax2(tensor *out__, tensor self, int64_t dim) {
  PROTECT(
...
void atg_logspace1(tensor *out__, scalar start, scalar end, int options_kind, int options_device) {
  PROTECT(
...
void atg_logspace2(tensor *out__, scalar start, scalar end, int64_t steps, int options_kind, int options_device) {
  PROTECT(
...
void atg_logspace_out1(tensor *out__, tensor result, scalar start, scalar end) {
  PROTECT(
...
void atg_logspace_out2(tensor *out__, tensor result, scalar start, scalar end, int64_t steps) {
  PROTECT(
...
void atg_lstm1(tensor *out__, tensor input, tensor *hx_data, int hx_len, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional, int batch_first) {
  PROTECT(
...
void atg_lstm2(tensor *out__, tensor data, tensor batch_sizes, tensor *hx_data, int hx_len, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional) {
  PROTECT(
...
void atg_lt(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_lt1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::lt(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_lt_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_lt_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->lt_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_lt_out1(tensor *out__, tensor result, tensor self, scalar other) {
  PROTECT(
...
void atg_lt_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
    auto outputs__ = torch::lt_out(*result, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_masked_fill_1(tensor *out__, tensor self, tensor mask, scalar value) {
  PROTECT(
...
void atg_masked_fill_2(tensor *out__, tensor self, tensor mask, tensor value) {
  PROTECT(
    auto outputs__ = self->masked_fill_(*mask, *value);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_matrix_rank2(tensor *out__, tensor self, int symmetric) {
  PROTECT(
...
void atg_max(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_max1(tensor *out__, tensor self, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_max2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_max_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
...
void atg_max_pool1d(tensor *out__, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int ceil_mode) {
  PROTECT(
...
void atg_max_pool1d_with_indices(tensor *out__, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int ceil_mode) {
  PROTECT(
...
void atg_max_pool2d(tensor *out__, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int ceil_mode) {
  PROTECT(
...
void atg_max_pool2d_with_indices_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int ceil_mode, tensor indices) {
  PROTECT(
...
void atg_max_pool3d_with_indices_backward(tensor *out__, tensor grad_output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int ceil_mode, tensor indices) {
  PROTECT(
...
void atg_max_pool3d_with_indices_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *kernel_size_data, int kernel_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len, long int *dilation_data, int dilation_len, int ceil_mode, tensor indices) {
  PROTECT(
...
void atg_max_unpool2d(tensor *out__, tensor self, tensor indices, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_max_unpool2d_backward(tensor *out__, tensor grad_output, tensor self, tensor indices, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_max_unpool2d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, tensor indices, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_max_unpool2d_forward(tensor *out__, tensor self, tensor indices, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::max_unpool2d_forward(*self, *indices, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_max_unpool2d_forward_out(tensor *out__, tensor output, tensor self, tensor indices, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::max_unpool2d_forward_out(*output, *self, *indices, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_max_unpool2d_out(tensor *out__, tensor output, tensor self, tensor indices, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_max_unpool3d(tensor *out__, tensor self, tensor indices, long int *output_size_data, int output_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_max_unpool3d_backward(tensor *out__, tensor grad_output, tensor self, tensor indices, long int *output_size_data, int output_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_max_unpool3d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, tensor indices, long int *output_size_data, int output_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_max_unpool3d_forward(tensor *out__, tensor self, tensor indices, long int *output_size_data, int output_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::max_unpool3d_forward(*self, *indices, torch::IntList(output_size_data, output_size_len), torch::IntList(stride_data, stride_len), torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_max_unpool3d_forward_out(tensor *out__, tensor output, tensor self, tensor indices, long int *output_size_data, int output_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::max_unpool3d_forward_out(*output, *self, *indices, torch::IntList(output_size_data, output_size_len), torch::IntList(stride_data, stride_len), torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_max_unpool3d_out(tensor *out__, tensor output, tensor self, tensor indices, long int *output_size_data, int output_size_len, long int *stride_data, int stride_len, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_mean2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_mean3(tensor *out__, tensor self, int64_t dim, int keepdim, int dtype) {
  PROTECT(
...
void atg_mean4(tensor *out__, tensor self, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_mean5(tensor *out__, tensor self, int64_t dim, int dtype) {
  PROTECT(
...
void atg_mean_out1(tensor *out__, tensor result, tensor self, int64_t dim, int keepdim, int dtype) {
  PROTECT(
...
void atg_mean_out2(tensor *out__, tensor result, tensor self, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_mean_out3(tensor *out__, tensor result, tensor self, int64_t dim, int dtype) {
  PROTECT(
...
void atg_median2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_min(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_min1(tensor *out__, tensor self, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_min2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_min_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
...
void atg_miopen_convolution(tensor *out__, tensor self, tensor weight, tensor bias, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_miopen_convolution_backward_input(tensor *out__, long int *self_size_data, int self_size_len, tensor grad_output, tensor weight, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_miopen_convolution_backward_weight(tensor *out__, long int *weight_size_data, int weight_size_len, tensor grad_output, tensor self, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_miopen_convolution_transpose(tensor *out__, tensor self, tensor weight, tensor bias, long int *padding_data, int padding_len, long int *output_padding_data, int output_padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_miopen_convolution_transpose_backward_input(tensor *out__, tensor grad_output, tensor weight, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_miopen_convolution_transpose_backward_weight(tensor *out__, long int *weight_size_data, int weight_size_len, tensor grad_output, tensor self, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int benchmark, int deterministic) {
  PROTECT(
...
void atg_mkldnn_convolution(tensor *out__, tensor self, tensor weight, tensor bias, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups) {
  PROTECT(
...
void atg_mkldnn_convolution_backward_input(tensor *out__, long int *self_size_data, int self_size_len, tensor grad_output, tensor weight, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int bias_defined) {
  PROTECT(
...
void atg_mkldnn_convolution_backward_weights(tensor *out__, long int *weight_size_data, int weight_size_len, tensor grad_output, tensor self, long int *padding_data, int padding_len, long int *stride_data, int stride_len, long int *dilation_data, int dilation_len, int64_t groups, int bias_defined) {
  PROTECT(
...
void atg_mse_loss_forward(tensor *out__, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::mse_loss_forward(*self, *target, reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_mse_loss_forward_out(tensor *out__, tensor output, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::mse_loss_forward_out(*output, *self, *target, reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_multilabel_margin_loss_forward(tensor *out__, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::multilabel_margin_loss_forward(*self, *target, reduction);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_multilabel_margin_loss_forward_out(tensor *out__, tensor output, tensor is_target, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::multilabel_margin_loss_forward_out(*output, *is_target, *self, *target, reduction);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_ne(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_ne1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::ne(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_ne_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_ne_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->ne_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_ne_out1(tensor *out__, tensor result, tensor self, scalar other) {
  PROTECT(
...
void atg_ne_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
    auto outputs__ = torch::ne_out(*result, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_nll_loss2d_forward(tensor *out__, tensor self, tensor target, tensor weight, int64_t reduction, int64_t ignore_index) {
  PROTECT(
    auto outputs__ = torch::nll_loss2d_forward(*self, *target, (weight ? *weight : torch::Tensor()), reduction, ignore_index);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_nll_loss2d_forward_out(tensor *out__, tensor output, tensor total_weight, tensor self, tensor target, tensor weight, int64_t reduction, int64_t ignore_index) {
  PROTECT(
    auto outputs__ = torch::nll_loss2d_forward_out(*output, *total_weight, *self, *target, (weight ? *weight : torch::Tensor()), reduction, ignore_index);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_nll_loss_forward(tensor *out__, tensor self, tensor target, tensor weight, int64_t reduction, int64_t ignore_index) {
  PROTECT(
    auto outputs__ = torch::nll_loss_forward(*self, *target, (weight ? *weight : torch::Tensor()), reduction, ignore_index);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_nll_loss_forward_out(tensor *out__, tensor output, tensor total_weight, tensor self, tensor target, tensor weight, int64_t reduction, int64_t ignore_index) {
  PROTECT(
    auto outputs__ = torch::nll_loss_forward_out(*output, *total_weight, *self, *target, (weight ? *weight : torch::Tensor()), reduction, ignore_index);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}
...
void atg_norm1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_norm2(tensor *out__, tensor self, scalar p, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_normal(tensor *out__, tensor mean, tensor std) {
  PROTECT(
...
void atg_normal1(tensor *out__, tensor mean, double std) {
  PROTECT(
    auto outputs__ = torch::normal(*mean, std);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_normal2(tensor *out__, double mean, tensor std) {
  PROTECT(
    auto outputs__ = torch::normal(mean, *std);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_normal_out1(tensor *out__, tensor output, tensor mean, double std) {
  PROTECT(
...
void atg_normal_out2(tensor *out__, tensor output, double mean, tensor std) {
  PROTECT(
    auto outputs__ = torch::normal_out(*output, mean, *std);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_normal_out3(tensor *out__, tensor output, tensor mean, tensor std) {
  PROTECT(
    auto outputs__ = torch::normal_out(*output, *mean, *std);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_ones(tensor *out__, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_ones_like1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_ones_like2(tensor *out__, tensor self, int options_kind, int options_device) {
  PROTECT(
...
void atg_ones_out(tensor *out__, tensor result, long int *size_data, int size_len) {
  PROTECT(
...
void atg_permute(tensor *out__, tensor self, long int *dims_data, int dims_len) {
  PROTECT(
...
void atg_pow1(tensor *out__, tensor self, scalar exponent) {
  PROTECT(
    auto outputs__ = torch::pow(*self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_pow_(tensor *out__, tensor self, tensor exponent) {
  PROTECT(
...
void atg_pow_1(tensor *out__, tensor self, scalar exponent) {
  PROTECT(
    auto outputs__ = self->pow_(*exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_pow_out1(tensor *out__, tensor result, tensor self, scalar exponent) {
  PROTECT(
...
void atg_pow_out2(tensor *out__, tensor result, tensor self, tensor exponent) {
  PROTECT(
    auto outputs__ = torch::pow_out(*result, *self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_pow_out3(tensor *out__, tensor result, scalar self, tensor exponent) {
  PROTECT(
    auto outputs__ = torch::pow_out(*result, *self, *exponent);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_prod2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_prod3(tensor *out__, tensor self, int64_t dim, int keepdim, int dtype) {
  PROTECT(
...
void atg_prod4(tensor *out__, tensor self, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_prod5(tensor *out__, tensor self, int64_t dim, int dtype) {
  PROTECT(
...
void atg_prod_out1(tensor *out__, tensor result, tensor self, int64_t dim, int keepdim, int dtype) {
  PROTECT(
...
void atg_prod_out2(tensor *out__, tensor result, tensor self, int64_t dim, int keepdim) {
  PROTECT(
...
void atg_prod_out3(tensor *out__, tensor result, tensor self, int64_t dim, int dtype) {
  PROTECT(
...
void atg_rand(tensor *out__, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_rand_like1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_rand_like2(tensor *out__, tensor self, int options_kind, int options_device) {
  PROTECT(
...
void atg_rand_out(tensor *out__, tensor result, long int *size_data, int size_len) {
  PROTECT(
...
void atg_randint1(tensor *out__, int64_t high, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_randint2(tensor *out__, int64_t low, int64_t high, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_randint_like1(tensor *out__, tensor self, int64_t high) {
  PROTECT(
...
void atg_randint_like2(tensor *out__, tensor self, int64_t low, int64_t high) {
  PROTECT(
...
void atg_randint_like3(tensor *out__, tensor self, int64_t high, int options_kind, int options_device) {
  PROTECT(
...
void atg_randint_like4(tensor *out__, tensor self, int64_t low, int64_t high, int options_kind, int options_device) {
  PROTECT(
...
void atg_randint_out1(tensor *out__, tensor result, int64_t high, long int *size_data, int size_len) {
  PROTECT(
...
void atg_randint_out2(tensor *out__, tensor result, int64_t low, int64_t high, long int *size_data, int size_len) {
  PROTECT(
...
void atg_randn(tensor *out__, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_randn_like1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_randn_like2(tensor *out__, tensor self, int options_kind, int options_device) {
  PROTECT(
...
void atg_randn_out(tensor *out__, tensor result, long int *size_data, int size_len) {
  PROTECT(
...
void atg_random_1(tensor *out__, tensor self, int64_t from, int64_t to) {
  PROTECT(
...
void atg_random_2(tensor *out__, tensor self, int64_t to) {
  PROTECT(
...
void atg_random_3(tensor *out__, tensor self) {
  PROTECT(
...
void atg_range2(tensor *out__, scalar start, scalar end, scalar step, int options_kind, int options_device) {
  PROTECT(
...
void atg_range_out1(tensor *out__, tensor result, scalar start, scalar end) {
  PROTECT(
...
void atg_range_out2(tensor *out__, tensor result, scalar start, scalar end, scalar step) {
  PROTECT(
...
void atg_reflection_pad1d(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_reflection_pad1d_backward(tensor *out__, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_reflection_pad1d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_reflection_pad1d_forward(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::reflection_pad1d_forward(*self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_reflection_pad1d_forward_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::reflection_pad1d_forward_out(*output, *self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_reflection_pad1d_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_reflection_pad2d(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_reflection_pad2d_backward(tensor *out__, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_reflection_pad2d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_reflection_pad2d_forward(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::reflection_pad2d_forward(*self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_reflection_pad2d_forward_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::reflection_pad2d_forward_out(*output, *self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_reflection_pad2d_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_remainder(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_remainder1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = torch::remainder(*self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_remainder_(tensor *out__, tensor self, tensor other) {
  PROTECT(
...
void atg_remainder_1(tensor *out__, tensor self, scalar other) {
  PROTECT(
    auto outputs__ = self->remainder_(*other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_remainder_out1(tensor *out__, tensor result, tensor self, scalar other) {
  PROTECT(
...
void atg_remainder_out2(tensor *out__, tensor result, tensor self, tensor other) {
  PROTECT(
    auto outputs__ = torch::remainder_out(*result, *self, *other);
    out__[0] = new torch::Tensor(outputs__);
  )
...
void atg_repeat(tensor *out__, tensor self, long int *repeats_data, int repeats_len) {
  PROTECT(
...
void atg_replication_pad1d(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad1d_backward(tensor *out__, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad1d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad1d_forward(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::replication_pad1d_forward(*self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_replication_pad1d_forward_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::replication_pad1d_forward_out(*output, *self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_replication_pad1d_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad2d(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad2d_backward(tensor *out__, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad2d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad2d_forward(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::replication_pad2d_forward(*self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_replication_pad2d_forward_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::replication_pad2d_forward_out(*output, *self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_replication_pad2d_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad3d(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad3d_backward(tensor *out__, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad3d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_replication_pad3d_forward(tensor *out__, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::replication_pad3d_forward(*self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_replication_pad3d_forward_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
    auto outputs__ = torch::replication_pad3d_forward_out(*output, *self, torch::IntList(padding_data, padding_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_replication_pad3d_out(tensor *out__, tensor output, tensor self, long int *padding_data, int padding_len) {
  PROTECT(
...
void atg_reshape(tensor *out__, tensor self, long int *shape_data, int shape_len) {
  PROTECT(
...
void atg_resize_(tensor *out__, tensor self, long int *size_data, int size_len) {
  PROTECT(
...
void atg_rnn_relu1(tensor *out__, tensor input, tensor hx, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional, int batch_first) {
  PROTECT(
...
void atg_rnn_relu2(tensor *out__, tensor data, tensor batch_sizes, tensor hx, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional) {
  PROTECT(
...
void atg_rnn_tanh1(tensor *out__, tensor input, tensor hx, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional, int batch_first) {
  PROTECT(
...
void atg_rnn_tanh2(tensor *out__, tensor data, tensor batch_sizes, tensor hx, tensor *params_data, int params_len, int has_biases, int64_t num_layers, double dropout, int train, int bidirectional) {
  PROTECT(
...
void atg_roipooling2d_forward(tensor *out__, tensor input, tensor rois, int64_t pooledHeight, int64_t pooledWidth, double spatialScale) {
  PROTECT(
    auto outputs__ = torch::RoiPooling2d_forward(*input, *rois, pooledHeight, pooledWidth, spatialScale);
    out__[0] = new torch::Tensor(std::get<0>(outputs__));
    out__[1] = new torch::Tensor(std::get<1>(outputs__));
  )
}

void atg_roll(tensor *out__, tensor self, long int *shifts_data, int shifts_len, long int *dims_data, int dims_len) {
  PROTECT(
...
void atg_rot90(tensor *out__, tensor self, int64_t k, long int *dims_data, int dims_len) {
  PROTECT(
...
void atg_scatter_1(tensor *out__, tensor self, int64_t dim, tensor index, tensor src) {
  PROTECT(
...
void atg_scatter_2(tensor *out__, tensor self, int64_t dim, tensor index, scalar value) {
  PROTECT(
...
void atg_set_(tensor *out__, tensor self, tensor source) {
  PROTECT(
...
void atg_set_1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_smooth_l1_loss_forward(tensor *out__, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::smooth_l1_loss_forward(*self, *target, reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_smooth_l1_loss_forward_out(tensor *out__, tensor output, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::smooth_l1_loss_forward_out(*output, *self, *target, reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_soft_margin_loss_forward(tensor *out__, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::soft_margin_loss_forward(*self, *target, reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_soft_margin_loss_forward_out(tensor *out__, tensor output, tensor self, tensor target, int64_t reduction) {
  PROTECT(
    auto outputs__ = torch::soft_margin_loss_forward_out(*output, *self, *target, reduction);
    out__[0] = new torch::Tensor(outputs__);
  )
}
...
void atg_softmax2(tensor *out__, tensor self, int64_t dim) {
  PROTECT(
...
void atg_sparse_coo_tensor1(tensor *out__, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_sparse_coo_tensor2(tensor *out__, tensor indices, tensor values, int options_kind, int options_device) {
  PROTECT(
...
void atg_sparse_coo_tensor3(tensor *out__, tensor indices, tensor values, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_sparse_resize_(tensor *out__, tensor self, long int *size_data, int size_len, int64_t sparse_dim, int64_t dense_dim) {
  PROTECT(
...
void atg_sparse_resize_and_clear_(tensor *out__, tensor self, long int *size_data, int size_len, int64_t sparse_dim, int64_t dense_dim) {
  PROTECT(
...
void atg_squeeze1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_squeeze2(tensor *out__, tensor self, int64_t dim) {
  PROTECT(
...
void atg_squeeze_1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_squeeze_2(tensor *out__, tensor self, int64_t dim) {
  PROTECT(
...
void atg_std1(tensor *out__, tensor self, int unbiased) {
  PROTECT(
...
void atg_std2(tensor *out__, tensor self, int64_t dim, int unbiased, int keepdim) {
  PROTECT(
...
void atg_sum2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_sum3(tensor *out__, tensor self, long int *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
...
void atg_sum4(tensor *out__, tensor self, long int *dim_data, int dim_len, int keepdim) {
  PROTECT(
...
void atg_sum5(tensor *out__, tensor self, long int *dim_data, int dim_len, int dtype) {
  PROTECT(
...
void atg_sum_out1(tensor *out__, tensor result, tensor self, long int *dim_data, int dim_len, int keepdim, int dtype) {
  PROTECT(
...
void atg_sum_out2(tensor *out__, tensor result, tensor self, long int *dim_data, int dim_len, int keepdim) {
  PROTECT(
...
void atg_sum_out3(tensor *out__, tensor result, tensor self, long int *dim_data, int dim_len, int dtype) {
  PROTECT(
...
void atg_tensordot(tensor *out__, tensor self, tensor other, long int *dims_self_data, int dims_self_len, long int *dims_other_data, int dims_other_len) {
  PROTECT(
...
void atg_to2(tensor *out__, tensor self, int options_kind, int options_device, int non_blocking, int copy) {
  PROTECT(
...
void atg_to3(tensor *out__, tensor self, int device, int dtype, int non_blocking, int copy) {
  PROTECT(
...
void atg_to4(tensor *out__, tensor self, int dtype, int non_blocking, int copy) {
  PROTECT(
...
void atg_to5(tensor *out__, tensor self, tensor other, int non_blocking, int copy) {
  PROTECT(
...
void atg_to_sparse2(tensor *out__, tensor self) {
  PROTECT(
...
void atg_upsample_bilinear2d(tensor *out__, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_bilinear2d_backward(tensor *out__, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_bilinear2d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_bilinear2d_forward(tensor *out__, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
    auto outputs__ = torch::upsample_bilinear2d_forward(*self, torch::IntList(output_size_data, output_size_len), (bool)align_corners);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_bilinear2d_forward_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
    auto outputs__ = torch::upsample_bilinear2d_forward_out(*output, *self, torch::IntList(output_size_data, output_size_len), (bool)align_corners);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_bilinear2d_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_linear1d(tensor *out__, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_linear1d_backward(tensor *out__, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_linear1d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_linear1d_forward(tensor *out__, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
    auto outputs__ = torch::upsample_linear1d_forward(*self, torch::IntList(output_size_data, output_size_len), (bool)align_corners);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_linear1d_forward_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
    auto outputs__ = torch::upsample_linear1d_forward_out(*output, *self, torch::IntList(output_size_data, output_size_len), (bool)align_corners);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_linear1d_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_nearest1d(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_upsample_nearest1d_backward(tensor *out__, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len) {
  PROTECT(
...
void atg_upsample_nearest1d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len) {
  PROTECT(
...
void atg_upsample_nearest1d_forward(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::upsample_nearest1d_forward(*self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_nearest1d_forward_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::upsample_nearest1d_forward_out(*output, *self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_nearest1d_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_upsample_nearest2d(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_upsample_nearest2d_backward(tensor *out__, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len) {
  PROTECT(
...
void atg_upsample_nearest2d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len) {
  PROTECT(
...
void atg_upsample_nearest2d_forward(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::upsample_nearest2d_forward(*self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_nearest2d_forward_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::upsample_nearest2d_forward_out(*output, *self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_nearest2d_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_upsample_nearest3d(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_upsample_nearest3d_backward(tensor *out__, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len) {
  PROTECT(
...
void atg_upsample_nearest3d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len) {
  PROTECT(
...
void atg_upsample_nearest3d_forward(tensor *out__, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::upsample_nearest3d_forward(*self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_nearest3d_forward_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
    auto outputs__ = torch::upsample_nearest3d_forward_out(*output, *self, torch::IntList(output_size_data, output_size_len));
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_nearest3d_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len) {
  PROTECT(
...
void atg_upsample_trilinear3d(tensor *out__, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_trilinear3d_backward(tensor *out__, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_trilinear3d_backward_out(tensor *out__, tensor grad_input, tensor grad_output, long int *output_size_data, int output_size_len, long int *input_size_data, int input_size_len, int align_corners) {
  PROTECT(
...
void atg_upsample_trilinear3d_forward(tensor *out__, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
    auto outputs__ = torch::upsample_trilinear3d_forward(*self, torch::IntList(output_size_data, output_size_len), (bool)align_corners);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_trilinear3d_forward_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
    auto outputs__ = torch::upsample_trilinear3d_forward_out(*output, *self, torch::IntList(output_size_data, output_size_len), (bool)align_corners);
    out__[0] = new torch::Tensor(outputs__);
  )
}

void atg_upsample_trilinear3d_out(tensor *out__, tensor output, tensor self, long int *output_size_data, int output_size_len, int align_corners) {
  PROTECT(
...
void atg_var1(tensor *out__, tensor self, int unbiased) {
  PROTECT(
...
void atg_var2(tensor *out__, tensor self, int64_t dim, int unbiased, int keepdim) {
  PROTECT(
...
void atg_view(tensor *out__, tensor self, long int *size_data, int size_len) {
  PROTECT(
...
void atg_zeros(tensor *out__, long int *size_data, int size_len, int options_kind, int options_device) {
  PROTECT(
...
void atg_zeros_like1(tensor *out__, tensor self) {
  PROTECT(
...
void atg_zeros_like2(tensor *out__, tensor self, int options_kind, int options_device) {
  PROTECT(
...
void atg_zeros_out(tensor *out__, tensor result, long int *size_data, int size_len) {
  PROTECT(
